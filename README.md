...
|   **2** | **AZ-500 domain2: Implement platform protection** (4 Modules)
...
|   **3** | **AZ-500 domain 3: Secure your data and applications** (4 Modules)
...
|   **4** | **AZ-500 domain 4: Manage security operation** (3 Modules)
